      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12">
            ...
            <h2 className="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Pricing scales with your contests</h2>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative px-8 py-10 md:py-12 rounded-3xl border border-slate-800 bg-slate-900/40">
              ...
              <div className="text-center">
                <a className="btn text-slate-900 bg-linear-to-r from-white/80 via-white to-white/80 hover:bg-white transition duration-150 ease-in-out group" href="#contact">
