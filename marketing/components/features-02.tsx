                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                        <div className="mb-5">
                          <div>
                            <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">One API, same shape for everyone</h3>
                            <p className="text-slate-400">Tenant-scoped REST endpoints for identity, contests, scoring, leaderboards, and prize delivery. Whatever your stack — Rails, Node, Go, Django — you integrate the same way Adidas would.</p>
                          </div>
                        </div>
                        <div>
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">Signed webhooks, hardened</h3>
                          <p className="text-slate-400">HMAC-SHA256 signed events. Exponential backoff. Idempotency keys. Dead-letter routing on permanent failure. The boring stuff, done right.</p>
                        </div>
                      </div>
                      {/* Image */}
                ...
                <HighlighterItem>
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          <h3 className="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">Multi-tenant isolation</h3>
                          <p className="text-slate-400">Every row carries a tenant_id. No shared schemas. No cross-tenant leaks. Your data stays yours.</p>
                        </div>
                      </div>
                      {/* Image */}
                      <div className="relative w-full h-64 md:h-auto overflow-hidden md:pb-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Idempotent writes</h4>
              </div>
              <p className="text-sm text-slate-400">Send the same event twice; the second is a no-op. No double-scores, no double-charges.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Geo-eligibility</h4>
              </div>
              <p className="text-sm text-slate-400">Restrict participation by country at the contest level. Server-enforced, not client-trusted.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Bracket tournaments</h4>
              </div>
              <p className="text-sm text-slate-400">Multi-round contests with seeding, advancement rules, and full bracket trees.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Sponsored prizes</h4>
              </div>
              <p className="text-sm text-slate-400">Attach sponsor brands and reward currencies to any contest. Multiple sponsors per contest supported.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Anti-cheat blocks</h4>
              </div>
              <p className="text-sm text-slate-400">PI-to-PI blocks, submission anti-cheat, and juror review for creative contests.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Live leaderboards</h4>
              </div>
              <p className="text-sm text-slate-400">Ranks recompute on every scored entry. Pushed to your endpoint via webhook.</p>
            </div>
          </div>
