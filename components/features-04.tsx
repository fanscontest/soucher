      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">Why brands trust us</h2>
            <p className="text-lg text-slate-400">Three disciplines underpin everything we ship: how we hold your fans, how we deliver events, and how we keep your data yours.</p>
          </div>
          ...
          <div className="divide-y divide-slate-800">
            ...
            <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">Identity</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">PlatformIdentity</h4>
                  </div>
                  <p className="text-sm text-slate-400">Lightweight fan records. Display name plus optional geo. We never store emails or phones.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Tenant API keys</h4>
                  </div>
                  <p className="text-sm text-slate-400">fcn_* keys with rotation, scoping, and per-key audit. Issue and revoke without downtime.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Tenant-scoped reads</h4>
                  </div>
                  <p className="text-sm text-slate-400">Every query carries tenant_id. Cross-tenant leaks are impossible at the row level.</p>
                </div>
              </div>
            </div>
            {/* Row */}
            <div className="py-8">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">Resilience</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Signed webhooks</h4>
                  </div>
                  <p className="text-sm text-slate-400">HMAC-SHA256 signatures per event, per tenant secret. Verify before you trust.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Idempotency keys</h4>
                  </div>
                  <p className="text-sm text-slate-400">Send the same event twice; the second is a no-op. Safe to retry, always.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Dead-letter on failure</h4>
                  </div>
                  <p className="text-sm text-slate-400">After max attempts, events land in a queue you can replay, inspect, or audit.</p>
                </div>
              </div>
            </div>
            {/* Row */}
            <div className="py-8">
              <div>
                <div className="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">Operations</div>
              </div>
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Audit log</h4>
                  </div>
                  <p className="text-sm text-slate-400">Every tenant-bound action timestamped, scoped, and queryable. No mysteries.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">OpenTelemetry traces</h4>
                  </div>
                  <p className="text-sm text-slate-400">Distributed traces from API call to webhook delivery. Exportable to your stack.</p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Per-tenant isolation</h4>
                  </div>
                  <p className="text-sm text-slate-400">Strict tenant boundaries. No shared schemas, no shared queries, no surprise leaks.</p>
                </div>
              </div>
            </div>
          </div>
